  ...
  return (
    <div className="space-y-3 rounded-card border border-[hsl(var(--destructive)/0.22)] bg-[hsl(var(--destructive)/0.06)] p-4">
      ...
      <input
        ...
        className="block w-full rounded-md border border-border bg-card px-3.5 py-2.5 text-base shadow-xs md:text-ui focus:border-destructive focus:outline-none focus:ring-2 focus:ring-destructive/40"
      />
      <div className="flex flex-wrap items-center gap-2">
        <Button
          type="button"
