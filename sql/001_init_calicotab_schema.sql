...
CREATE TABLE IF NOT EXISTS tournament_participants (
  ...
  speaker_rank_open INTEGER,
  speaker_rank_esl INTEGER,
  speaker_rank_efl INTEGER,
  team_break_rank INTEGER,
  team_score_total NUMERIC,
  judge_type_tag TEXT,
  chaired_prelim_rounds INTEGER,
  last_outround_chaired TEXT,
  last_outround_paneled TEXT,
  wins INTEGER,
  losses INTEGER,
